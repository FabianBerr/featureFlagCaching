...
const LOG = cds.log('catalog-service-features')
...
module.exports = class CatalogService extends cds.ApplicationService {
  init() {
    ...
    this.after("READ", "Books", function (req, next) {

      const { features } = cds.context
      if ('isbn' in features) {
        LOG.info("Feature 'isbn' is enabled, applying specific coding for Books entity");
      }
      else {
        LOG.info("Feature 'isbn' is not enabled");
      }
    });
